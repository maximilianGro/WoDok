package eHealth.config;

import eHealth.config.properties.SecurityProperties;
import eHealth.security.JwtAuthenticationFilter;
import eHealth.security.JwtAuthorizationFilter;
import eHealth.security.JwtTokenizer;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public SecurityConfig(UserService userService,
                          ...
                          @Lazy SecurityProperties securityProperties, @Lazy JwtTokenizer jwtTokenizer) {
